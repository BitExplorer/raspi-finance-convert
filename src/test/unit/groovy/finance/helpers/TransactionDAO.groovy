...
class TransactionDAO {
    ...
    int transactionCount()  {
        return jdbcTemplate.queryForObject("SELECT COUNT(*) FROM t_transaction", Ineger)
    }

    int transactionCategoriesCount() {
        return jdbcTemplate.queryForObject("SELECT COUNT(*) FROM t_transaction_categories", Integera)
    }
}